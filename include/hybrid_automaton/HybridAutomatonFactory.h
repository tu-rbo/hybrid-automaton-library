...
public:
    ...
    ha::HybridAutomaton::Ptr createInitialHybridAutomaton(const GripperType& gripper,
                                                          ...
                                                          const Eigen::MatrixXd& pos_epsilon_js_arm = Eigen::MatrixXd());
    ...
    /**
         ...
         */
    ha::Controller::Ptr createOperationalSpaceController(std::string name, const Eigen::MatrixXd &pos, const Eigen::MatrixXd &ori, double completionTime);
    ...
    /**
         ...
         */
    ha::Controller::Ptr createOperationalSpaceControllerTF(std::string name, const std::string frame, double max_displacement_velocity, double max_rotational_velocity);
    ...
    ha::JumpCondition::Ptr createJointSpaceControllerGoalConvergenceCondition(ha::ControllerConstPtr js_ctrl,
                                                                              const Eigen::MatrixXd& pos_epsilon_js = Eigen::MatrixXd());
     ...
     */
    ha::JumpCondition::Ptr createSubjointSpaceControllerGoalConvergenceCondition(ha::ControllerConstPtr subjs_ctrl,
                                                                   const Eigen::MatrixXd& index_vec,
     ...
     * @return ha::JumpCondition::Ptr Pointer to the generated jump condition
     */
    ha::JumpCondition::Ptr createSubjointSpaceControllerArmGoalConvergenceCondition(ha::ControllerConstPtr subjs_ctrl,
                                                                   const Eigen::MatrixXd& index_vec_arm = Eigen::MatrixXd(),
                                                                   const Eigen::MatrixXd& pos_epsilon_js_arm = Eigen::MatrixXd());
    /**
     ...
     * @return ha::JumpCondition::Ptr Pointer to the generated jump condition
     */
    ha::JumpCondition::Ptr createSubjointSpaceControllerBaseGoalConvergenceCondition(ha::ControllerConstPtr subjs_ctrl,
                                                                       const Eigen::MatrixXd& index_vec_base = Eigen::MatrixXd(),
                                                                       const Eigen::MatrixXd& pos_epsilon_js_base = Eigen::MatrixXd());

    ha::JumpCondition::Ptr createJointSpaceConvergenceWithVelocityCondition(const Eigen::MatrixXd& index_vec,
     ...
     * @return ha::JumpCondition::Ptr Pointer to the generated jump condition
     */
    ha::JumpCondition::Ptr createJointSpaceConvergenceWithZeroVelocityCondition(const Eigen::MatrixXd& index_vec,
                                                                                const Eigen::MatrixXd& vel_epsilon_js);
     ...
     * @return ha::JumpCondition::Ptr Pointer to the generated jump condition
     */
    ha::JumpCondition::Ptr createJointSpaceArmConvergenceWithZeroVelocityCondition(const Eigen::MatrixXd& index_vec_arm = Eigen::MatrixXd(),
                                                                                   const Eigen::MatrixXd& vel_epsilon_js_arm = Eigen::MatrixXd());
     ...
     * @return ha::JumpCondition::Ptr Pointer to the generated jump condition
     */
    ha::JumpCondition::Ptr createJointSpaceBaseConvergenceWithZeroVelocityCondition(const Eigen::MatrixXd &index_vec_base = Eigen::MatrixXd(),
                                                                                    const Eigen::MatrixXd& vel_epsilon_js_base = Eigen::MatrixXd());
    ...
    Eigen::MatrixXd pos_epsilon_js_arm() const;
    void setPos_epsilon_js_arm(const Eigen::MatrixXd &pos_epsilon_js_arm);

    Eigen::MatrixXd pos_epsilon_js_base() const;
    void setPos_epsilon_js_base(const Eigen::MatrixXd &pos_epsilon_js_base);

    Eigen::MatrixXd vel_epsilon_js_arm() const;
    void setVel_epsilon_js_arm(const Eigen::MatrixXd &vel_epsilon_js_arm);

    Eigen::MatrixXd vel_epsilon_js_base() const;
    void setVel_epsilon_js_base(const Eigen::MatrixXd &vel_epsilon_js_base);

    Eigen::MatrixXd pos_epsilon_os_linear() const;
    void setPos_epsilon_os_linear(const Eigen::MatrixXd &pos_epsilon_os_linear);

    Eigen::MatrixXd pos_epsilon_os_angular() const;
    void setPos_epsilon_os_angular(const Eigen::MatrixXd &pos_epsilon_os_angular);

    Eigen::MatrixXd vel_epsilon_os_linear() const;
    void setVel_epsilon_os_linear(const Eigen::MatrixXd &vel_epsilon_os_linear);

    Eigen::MatrixXd vel_epsilon_os_angular() const;
    void setVel_epsilon_os_angular(const Eigen::MatrixXd &vel_epsilon_os_angular);
